...
public class ApiExceptionHandler extends ResponseEntityExceptionHandler	{
	...
	protected ResponseEntity<Object> handleNoHandlerFoundException(NoHandlerFoundException ex, HttpHeaders headers,
		...
		String detail = String.format("O recurso '%s' que você tentou acessar é inexistente. "
				+ "Verifique a URI desejada.", ex.getRequestURL());
...
@Override
	...
	private ResponseEntity<Object> handleMethodArgumentTypeMismatch(MethodArgumentTypeMismatchException ex,
		...
		String valorRecebido = ex.getValue().toString();
		String tipoCorretoParametro = ex.getRequiredType().getSimpleName();

		String detail = String.format("O parâmetro de url '%s' recebeu o valor '%s', que é de um tipo inválido. "
				+ "Corrija e informe o valor compatível com o tipo '%s'.", nomeParametro, valorRecebido, tipoCorretoParametro);
	...
	private ResponseEntity<Object> handlePropertyBinding(PropertyBindingException ex,
		...
		String detail = String.format("A propriedade '%s' não existe ou não deve ser informada. "
